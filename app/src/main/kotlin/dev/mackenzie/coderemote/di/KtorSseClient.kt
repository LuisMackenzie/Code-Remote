...
import dev.mackenzie.coderemote.data.api.SseAuthException
import dev.mackenzie.coderemote.data.api.SseClient
import dev.mackenzie.coderemote.data.api.SseConnectionException
...
class KtorSseClient @Inject constructor(
     ...
     */
    override fun connectToGlobalEvents(conn: ServerConnection, directory: String?): Flow<SseEvent> = flow {
